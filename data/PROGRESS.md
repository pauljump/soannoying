...
The current pass uses a local Qwen3 14B model over Tailscale. It is cheap to run and good enough for first-pass extraction. The model is not making final judgments. These are still raw leads, and the public release remains the smaller, reviewed boundary described in the README.
